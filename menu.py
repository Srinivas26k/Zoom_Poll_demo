...
class MenuSystem:
    ...
    def run_first_time_setup(self):
        ...
        try:
            ...
            subprocess.run([str(python_path), "-m", "pip", "install", "rich", "python-dotenv", "setuptools", "requests"], check=True)
            console.print("[green]✓ Base dependencies installed[/green]")
            ...
            subprocess.run([str(python_path), "-m", "pip", "install", "-r", str(self.requirements_file)], check=True)
